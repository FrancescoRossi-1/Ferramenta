...
public class IndirizziDiSpedizioneBean implements Serializable {
	...
	private IndirizzoDiSpedizione indirizzoDiSpedizioneSelezionato;
	...
	public void init() {
		...
		indirizzoDiSpedizioneSelezionato = new IndirizzoDiSpedizione();
	...
	public void insertIndirizzoDiSpedizione() {
		...
		try {
			...
			init(); 
			PrimeFaces.current().ajax().update("menuForm:tabView:accorditionIndirizziSpedizione:scrollerIndirizziSpedizione"); //aggiornamento pagina visualizzazzione indirizzi
	...
	public void deleteIndirizzoDiSpedizione( IndirizzoDiSpedizione indirizzoDiSpedizione ) {
		...
		try {
			...
			init();
			PrimeFaces.current().ajax().update("menuForm:tabView:accorditionIndirizziSpedizione:scrollerIndirizziSpedizione");
	...
	public IndirizzoDiSpedizione getIndirizzoDiSpedizioneSelezionato() {
		return indirizzoDiSpedizioneSelezionato;
	}

	public void setIndirizzoDiSpedizioneSelezionato(IndirizzoDiSpedizione indirizzoDiSpedizioneSelezionato) {
	...
	public ArrayList<Entry<Indirizzo, IndirizzoDiSpedizione>> getIndirizziMap() {
		...
		return new ArrayList<Map.Entry<Indirizzo,IndirizzoDiSpedizione>>(indirizziSet);
	}
